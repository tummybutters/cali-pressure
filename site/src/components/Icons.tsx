...
const brandBase = "h-6 w-6 fill-current";
...
export function InstagramIcon({ className = "" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`h-6 w-6 fill-none stroke-[1.9] stroke-current [stroke-linecap:round] [stroke-linejoin:round] ${className}`}
      aria-hidden="true"
    >
...
export function TikTokIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={`${brandBase} ${className}`} aria-hidden="true">
  ...
  return (
    <svg viewBox="0 0 24 24" className={`${brandBase} ${className}`} aria-hidden="true">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7Zm0 9.7a2.7 2.7 0 1 0 0-5.4 2.7 2.7 0 0 0 0 5.4Z"
      />
    </svg>
  );
}
